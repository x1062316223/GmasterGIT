...
<body>
	<div class="container">
		<div class="modal-header">
			<h1 style="display: inline-block;">PC</h1>
		...
		<div class="row">
			...
			if ( isset( $_POST[ 'order' ] ) ) {
				$sql = 'SELECT id, name, price FROM p_list WHERE type = "pc"';
				switch ( $_POST[ 'order' ] ) {
					case 'n_az':
				...
				$sql = 'SELECT id, name, price FROM p_list WHERE type = "pc" ORDER BY name ASC';
			}
