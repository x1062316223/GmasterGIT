...
<body>
	<div class="container">
		<div class="modal-header">
			<h1 style="display: inline-block;">PS4</h1>
		...
		<div class="row">
			...
			if ( isset( $_POST[ 'order' ] ) ) {
				$sql = 'SELECT id, name, price FROM p_list WHERE type = "ps4"';
				switch ( $_POST[ 'order' ] ) {
					case 'n_az':
				...
				$sql = 'SELECT id, name, price FROM p_list WHERE type = "ps4" ORDER BY name ASC';
			}
